...
//Tab 1
    ...
    @FindBy(xpath = "//input[@name='office_address' and @placeholder='Enter Pincode']")
    ...
    @FindBy(xpath = "//input[@name='address_line2' and @placeholder='Enter Pincode']")
    ...
    private WebElement enterWitnessName;
    ...
    @FindBy(xpath = "//p[contains(text(),'Marriage')]/parent::div/parent::div/parent::div/div[2]/input")
    ...
    public void deleteDocumentSet3() {
        safe.safeClick(downArrow3, "Down Arrow Icon");
        safe.safeClick(deleteIcon, "Delete Icon");
        safe.safeClick(yesButton, "Yes Button");
    }
...
//tab 2- Witness Details
    public void typeWitnessName(String witnessName) {
        safe.safeType(enterWitnessName, witnessName, "Witness Name");
    }
    ...
    @FindBy(xpath = "//li[contains(@class, 'select2-results__option') and text()='Apply for Name Change']")
    ...
    public void selectingtheservice(String Namechange) {
        String xpath = String.format("//li[contains(@class, 'select2-results__option') and text()='%s']", Namechange);
        WebElement element = driver.findElement(By.xpath(xpath));
        safe.safeClick(element, "Selecting " + Namechange);
    }
