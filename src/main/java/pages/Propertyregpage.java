...
public class Propertyregpage extends BasePage {

    private final WaitUtils wait;
    SafeActionUtils safe;

    public Propertyregpage(WebDriver driver) throws AWTException {
        super(driver);
        this.driver = driver;
    ...
    @FindBy(xpath = "//input[@placeholder='Enter Buyer/Donee/Transferee Details']")
    public WebElement Buyerdetails;

    @FindBy(xpath = "//input[@placeholder='Enter Location of property']")
    public WebElement locationofproperty;

    @FindBy(xpath = "//input[@placeholder='Enter Plot No / Survey No']")
    ...
    @FindBy(xpath = "//input[@placeholder='Enter Taluk']")
    public WebElement taluk;

    @FindBy(xpath = "//input[@placeholder='Enter Village']")
    public WebElement Villages;
    ...
    public void typeofproperty(String Typeofprop) throws InterruptedException {
        try {
            safe.safeType(typeofpropertyInput, Typeofprop, "Type of Property");
            Thread.sleep(1000);
            typeofpropertyInput.sendKeys(Keys.ENTER);
            logToAllure("Selection", "Selected Property Type: " + Typeofprop);
        } catch (Exception e) {
    ...
    public void landmark(String Typeofprop) {
        safe.safeType(landmark, Typeofprop, "Type of Property");
    }

    public void pincode(String Pincode) {
        safe.safeType(pincode, Pincode, "Pin code");
    }

    public void taluk(String SubDivision) {
        safe.safeType(taluk, SubDivision, "Sub Division");
    }

    public void Villages(String Village) {
        safe.safeType(Villages, Village, "Village");
    }
    @FindBy(xpath = "//a[@id='crossSaleNew']")
    public WebElement crossSaleNew;

    @FindBy(xpath = "//li[contains(@class, 'select2-results__option') and contains(text(), 'Property Registration')]")
...
//    }
    ...
    public void selectingtheservice(String PropertyReg) {
        String xpath = String.format("//li[contains(@class, 'select2-results__option') and text()='%s']", PropertyReg);
        WebElement element = driver.findElement(By.xpath(xpath));
        safe.safeClick(element, "Selecting " + PropertyReg);
    }
