...
public class StateFoodPage extends BasePage {
    private final WaitUtils wait;
    SafeActionUtils safe;
    SeleniumHelperMethods seleniumHelperMethods;
    public StateFoodPage(WebDriver driver) {
        super(driver);
    ...
    @FindBy(xpath = "//form/div/div/div/div/p[text()='Private Limited Company']")
    public WebElement chooseCompanyType;
    ...
    private WebElement selectTypeOfFood;;
    ...
    public void clickSameAsAddressCheckbox() {
        if(!seleniumHelperMethods.isElementEnabled(clickSameAsAddress)) {
    ...
    @FindBy(xpath = "//li[contains(@class, 'select2-results__option') and contains(text(), 'State Food License')]")
